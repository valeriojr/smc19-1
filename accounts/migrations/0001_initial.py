...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, choices=[('HM', 'Residencial'), ('WK', 'Trabalho')], default='', max_length=2, verbose_name='Tipo')),
                ('postal_code', models.CharField(blank=True, default='', max_length=8, verbose_name='CEP')),
                ('neighbourhood', models.CharField(blank=True, choices=[('BB', 'Benedito Bentes'), ('CU', 'Cidade Universitária'), ('GC', 'Graciliano Ramos'), ('JA', 'Jaraguá'), ('JC', 'Jacintinho'), ('JT', 'Jatiúca'), ('MG', 'Mangabeiras'), ('PV', 'Ponta Verde')], default='', max_length=2, verbose_name='Bairro')),
                ...
                ('city', models.CharField(blank=True, choices=[('ARA', 'Arapiraca'), ('MCZ', 'Maceió'), ('MDO', 'Marechal Deodoro'), ('PEN', 'Penedo'), ('UPM', 'União dos Palmares')], default='', max_length=3, verbose_name='Cidade')),
